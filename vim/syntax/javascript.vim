...
syntax keyword jsType           const undefined var void yield self
...
"" Code blocks
" there is a name collision with jsExpression in html.vim, hence the use of the '2' here
syntax cluster jsExpression2 contains=jsComment,jsLineComment,jsDocComment,jsStringD,jsStringS,jsRegexpString,jsNumber,jsFloat,jsSource,jsCommonJS,jsThis,jsType,jsOperator,jsBoolean,jsNull,jsFunction,jsGlobalObjects,jsExceptions,jsFutureKeys,jsDomErrNo,jsDomNodeConsts,jsHtmlEvents,jsDotNotation,jsBracket,jsParen,jsBlock,jsParenError
syntax cluster jsAll       contains=@jsExpression2,jsLabel,jsConditional,jsRepeat,jsBranch,jsStatement,jsTernaryIf
...
syntax region  jsTernaryIf matchgroup=jsTernaryIfOperator start=+?+  end=+:+  contains=@jsExpression2
...
syntax cluster  jsExpression contains=@jsAll,jsBracket,jsParen,jsBlock,jsParenError,@htmlPreproc
